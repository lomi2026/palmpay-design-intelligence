...
- The protected workspace retains a recoverable error boundary. Its former route-level skeleton boundary was removed because Next.js displayed it on every child-menu navigation; the current page now remains visible until the prefetched destination is ready, avoiding a repeated full-page loading flash.
