...
- Phase 3 draft API, dedicated four-type draft forms, attachment binding and upload controls, editor shell and permission-gated review center are verified; immutable published-version editing remains to be implemented. Cloudflare R2 activation remains deferred until a payment method is available
