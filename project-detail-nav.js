(() => {
  ...
  style.textContent = `
    ...
    .pp-project-summary__label{display:block;margin-bottom:4px;color:var(--muted);font-size:9px;font-weight:750;letter-spacing:.12em;text-transform:uppercase}
    ...
    @media(max-width:640px){
      ...
      .pp-detail-enhanced .workspace-back{max-width:150px;min-height:34px;padding:7px 10px!important;font-size:12px;overflow:hidden}
  ...
  const projectMeta = (window.PP_PROJECTS_DATA || []).find(project => project.file === currentFile);
