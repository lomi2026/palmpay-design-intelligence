...
export function DraftAttachments({ contentId, attachments }: { contentId: string; attachments: Attachment[] }) {
  ...
  return <section data-card-surface="" className="mt-6 grid gap-4 rounded-[22px] border border-white/[.1] bg-[#111] p-6 md:p-6">
    <div className="flex flex-wrap items-end justify-between gap-3"><h2 className="text-[24px] font-semibold tracking-[-.04em] text-white">附件与引用材料</h2><p className="text-xs text-white/45">单个文件最大 100 MB</p></div>
