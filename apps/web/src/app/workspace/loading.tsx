export default function WorkspaceLoading() {
  return (
    <main className="mx-auto max-w-[1440px] px-5 py-8 md:px-8 md:py-10" aria-busy="true" aria-label="正在加载工作台内容">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {Array.from({ length: 4 }, (_, index) => (
          <div key={index} className="h-44 animate-pulse rounded-[20px] border border-white/[.1] bg-white/[0.035]" />
        ))}
      </div>
