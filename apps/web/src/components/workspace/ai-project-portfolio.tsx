              ...
              return (
                <article className="group grid gap-4 px-5 py-5 transition hover:bg-white/[.035] md:grid-cols-[84px_minmax(0,1fr)_minmax(168px,.42fr)_auto] md:items-center md:gap-6 md:px-6" key={project.id}>
                  ...
                  <div className="min-w-0">
                    <Link className="inline-flex items-start gap-2 text-[17px] font-semibold leading-6 tracking-[-.025em] text-white transition group-hover:text-white/80" href={`/workspace/ai-projects/${project.slug}`} prefetch={false}>
