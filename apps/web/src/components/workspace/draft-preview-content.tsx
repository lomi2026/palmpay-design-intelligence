...
type Draft = {
  ...
  title: string;
  summary: string | null;
  draftVersion: { title?: string; summary?: string | null; body: unknown; versionNumber: number; versionStatus: string } | null;
