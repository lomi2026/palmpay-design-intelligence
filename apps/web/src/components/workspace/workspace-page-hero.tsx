...
export function WorkspaceHeroMetric({ value, label }: { value: string | number; label: string }) {
  return (
    <div className="min-w-[82px] rounded-[14px] border border-[var(--v9-line)] bg-[var(--v9-soft)] p-4">
...
export function WorkspacePageHero({ title, description, children, metric }: WorkspacePageHeroProps) {
  return (
    <header className="workspace-page-card relative overflow-hidden rounded-[22px] border border-[var(--v9-line)] bg-[var(--v9-panel)] px-6 py-7 sm:px-8">
